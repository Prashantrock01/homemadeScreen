...
class _NewEventState extends State<NewEvent> {
  ...
  // add time and add venue controllers
        ...
        child: Form(
          child: Column(
            ...
            children: <Widget>[
              ...
              // Textfields for addind time/date and venue 
              Column(
                children: <Widget>[
                  buildCustomTextFormField(
                    ...
                    onTap: () => {datepicker(_timeController)},
                    boolValue: true,
                  ),
                  buildCustomTextFormField(
  ...
  Future<void> datepicker(TextEditingController con) async {
    ...
    if (pickedDate != null) {
      ...
      if (pickedTime != null) {
        ...
        con.text = DateFormat('M/dd/y hh:mm a').format(fullDateTime);
        setState(() => _selectedDate = fullDateTime);
      }
    }
  }
}
