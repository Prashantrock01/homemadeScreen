...
class BuyAndSellCreation extends StatefulWidget {
  const BuyAndSellCreation({super.key});

  @override
  State<BuyAndSellCreation> createState() => _BuyAndSellCreationState();
}

class _BuyAndSellCreationState extends State<BuyAndSellCreation> {
            ...
            onPressed: () async {
              ...
              try {
                ...
                scaffoldMessenger.showSnackBar(
                  const SnackBar(
                    content: Text('Successfully listed item.'),
                  ),
                );
